      ...
      >
        ...
        >
          ...
          <div
            v-else
            :key="selectedConversationId || 'empty'"
            class="flex-grow overflow-y-auto p-4 min-h-0"
          ...
          <div
            ...
            class="p-4 border-t border-gray-700 bg-gray-900 fixed md:sticky bottom-24 md:bottom-0 left-0 right-0 z-10 w-full md:w-auto"
          >
...
const handleViewPdf = async (resumeId) => {
  try {
    console.log("Fetching PDF for resume ID:", resumeId);
...
/* Фиксация поля ввода на мобильных устройствах */
@media (max-width: 767px) {
  .flex-grow.overflow-y-auto {
    /* Добавляем нижний паддинг, чтобы контент не скрывался под полем ввода */
    padding-bottom: 70px;
  }
}
</style>
